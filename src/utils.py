...
def loaddata(input_size, feature):
    trainData = ddio.load('../data/train.hdf5')
    testlabelData = ddio.load('../data/trainlabel.hdf5')
    ...
    valData = ddio.load('../data/test.hdf5')
    vallabelData = ddio.load('../data/testlabel.hdf5')
